from PyQt5.QtWidgets import QWidget, QApplication, QLabel, QPushButton,QToolTip,QMessageBox
import sys
...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('calculator_icon-icons.png'))


        self.label = QLabel(self)
        self.label.setText('0')
        self.label.resize(225, 65)
        self.move(0, 0)

        self.quit_1 = QPushButton('quit', self)
        self.quit_1.resize(50, 20)
        self.quit_1.move(165, 5)

        self.percent = QPushButton('%', self)
        QToolTip.setFont(QFont('SansSerif', 10))
        self.percent.setToolTip('This is a percentage of the number')
        self.percent.resize(70, 50)
        self.percent.move(5, 45)

        self.divis = QPushButton('//', self)
        QToolTip.setFont(QFont('SansSerif', 10))
        self.divis.setToolTip('This is an <b>integer</b> division')
        self.divis.resize(70, 50)
        self.divis.move(80, 45)

        self.squaring = QPushButton('x²', self)
        self.squaring.resize(65, 50)
        self.squaring.move(155, 45)
        ...
        self.divis.clicked.connect(self.divis_1)
